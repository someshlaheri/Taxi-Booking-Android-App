...
class PredictionTile extends StatelessWidget
{
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      SizedBox(height: 8.0,),
                      Text(
                        (placePredictions == null ? placePredictions.main_text : placePredictions.main_text) , overflow: TextOverflow.ellipsis,style: TextStyle(fontSize: 16.0),
                      ),

                      SizedBox(height: 2.0,),
                      Text(
                        (placePredictions == null ? placePredictions.secondary_text : placePredictions.main_text) , overflow: TextOverflow.ellipsis,style: TextStyle(fontSize: 12.0, color: Colors.grey),
                      ),
                      SizedBox(height: 8.0,),
                    ],
                  ),
  ...
  void getPlaceAddressDetails(String placeId, context) async
  {
    ...
    if(res["status"] == "OK")
    {
      ...
      print("This is Drop Your Off Location :: ");
